...
(function($) {
  $.TimerangeSetup = function() {
    ...
    $('#reportrange').daterangepicker({
      ...
      var url1 = $(location).attr('protocol') + '//' + $(location).attr('hostname') + ':' + $(location).attr('port') + $(location).attr('pathname')
      ...
      var url = url1 + '?instance=' + JMX_INSTANCE + '&start=' + start.toISOString() + '&end=' + end.toISOString()
